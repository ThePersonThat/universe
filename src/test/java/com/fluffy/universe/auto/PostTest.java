...
import com.fluffy.universe.auto.objects.PostCreationPage;
...
public class PostTest {
    ...
    void shouldCreatePost() {
        // when
        PostCreationPage postPage = new PostCreationPage(driver)
                .openPostPage()
                .enterTitle("Hello world")
                .enterDescription("Description")
                .clickSubmit();

        // then
        assertThat(postPage.isAlertShowed()).isTrue();
    }
}
